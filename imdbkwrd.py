...
PATH=Path('/scratch/ppachigo/3192771/fastai/data/aclImdb/')

CLAS_PATH=Path('/scratch/ppachigo/3192771/fastai/data/imdb_clas/')
CLAS_PATH.mkdir(exist_ok=True)

LM_PATH=Path('/scratch/ppachigo/3192771/fastai/data/imdb_lm/')
...
#tok_trn = np.load(CLAS_PATH/'tmp'/'tok_trn_bwd.npy')
#tok_val = np.load(CLAS_PATH/'tmp'/'tok_val_bwd.npy')
